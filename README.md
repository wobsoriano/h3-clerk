...
| `adjustProtoHeaderInDev` | `boolean` | Adjusts the `x-forwarded-proto` header in development mode to match the protocol of the request. Temporary hacky fix to [GitHub Issue #23348](https://github.com/nuxt/nuxt/issues/23348).                                                                                                                                                                                                                                                                                      |
